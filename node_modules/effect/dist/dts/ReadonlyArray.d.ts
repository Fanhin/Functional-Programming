...
export declare const span: {
    <C extends A, B extends A, A = C>(refinement: (a: A, i: number) => a is B): (self: Iterable<C>) => [init: Array<B>, rest: Array<Exclude<C, B>>];
...
export declare const splitWhere: {
    <B extends A, A = B>(predicate: (a: A, i: number) => boolean): (self: Iterable<B>) => [beforeMatch: Array<B>, fromMatch: Array<B>];
...
export declare const partition: {
    <C extends A, B extends A, A = C>(refinement: (a: A, i: number) => a is B): (self: Iterable<C>) => [excluded: Array<Exclude<C, B>>, satisfying: Array<B>];
    <B extends A, A = B>(predicate: (a: A, i: number) => boolean): (self: Iterable<B>) => [excluded: Array<B>, satisfying: Array<B>];
...
export declare const some: {
    <B extends A, A = B>(predicate: (a: A, i: number) => boolean): (self: ReadonlyArray<B>) => self is NonEmptyReadonlyArray<B>;
