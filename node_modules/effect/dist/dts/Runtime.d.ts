 ...
 * @category execution
 */
export declare const runCallback: <R>(runtime: Runtime<R>) => <E, A>(effect: Effect.Effect<R, E, A>, options?: RunCallbackOptions<E, A> | undefined) => (fiberId?: FiberId.FiberId | undefined, options?: RunCallbackOptions<E, A> | undefined) => void;
/**
